if (!self.define) {
    ...
    o[i] ||
      new Promise(o => {
        if ("document" in self) {
          ...
          ;(e.src = i), (e.onload = o), document.head.appendChild(e)
        } else (e = i), importScripts(i), o()
      }).then(() => {
        let e = o[i]
  ...
  self.define = (c, s) => {
    ...
    o[a] = Promise.all(c.map(e => b[e] || n(e))).then(e => (s(...e), r))
  }
}
define(["./workbox-50de5c5d"], function (e) {
  ...
  importScripts(),
    ...
    e.precacheAndRoute(
      [
        {
          url: "/_next/static/OBFaEW16e03cM4fc5B0kh/_buildManifest.js",
          revision: "2a553b23ab988a12d279a97e1463fc82",
        },
        {
          url: "/_next/static/OBFaEW16e03cM4fc5B0kh/_ssgManifest.js",
        ...
        {
          url: "/_next/static/chunks/424.2606369fd14308e6.js",
          revision: "2606369fd14308e6",
        },
        {
        ...
        {
          url: "/_next/static/chunks/490.78830ef16b670e92.js",
          revision: "78830ef16b670e92",
        },
        {
        ...
        {
          url: "/_next/static/chunks/660.3ae92ed277e57919.js",
          revision: "3ae92ed277e57919",
        },
        {
        ...
        {
          url: "/_next/static/chunks/704.cd0f7cf9836161c4.js",
          revision: "cd0f7cf9836161c4",
        },
        {
        ...
        {
          url: "/_next/static/chunks/pages/index-d477e13d2585c053.js",
          revision: "d477e13d2585c053",
        },
        {
        ...
        {
          url: "/_next/static/chunks/webpack-88297f0145383e0e.js",
          revision: "88297f0145383e0e",
        },
        {
          url: "/_next/static/css/0e6d4973d6d66931.css",
          revision: "0e6d4973d6d66931",
        },
        {
    ...
    e.registerRoute(
      ({ url: e }) => {
        ...
        const o = e.pathname
        return !o.startsWith("/api/auth/") && !!o.startsWith("/api/")
      },
      new e.NetworkFirst({
        cacheName: "apis",
